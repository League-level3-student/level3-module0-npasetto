...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		int input=Integer.parseInt(JOptionPane.showInputDialog("Enter a positive number."));
		//4. Initialize the array of JButtons to be the size of the int created in step 3
		buttons=new JButton[input+100];
		...
		hiddenButton=rand.nextInt(input+250);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(buttonClicked==buttons[hiddenButton]) {
			JOptionPane.showMessageDialog(null, "Correct BUTTON!!!!");
		}else {
